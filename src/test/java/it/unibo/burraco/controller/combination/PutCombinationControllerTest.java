...
class PutCombinationControllerTest {
    ...
    void testErrorIfNotDrawn() {
        ...
        PutCombinationResult result = controller.tryPutCombination(List.of(mock(Card.class)));
    ...
    void testSuccessTakePot() {
        ...
        Card c1 = new CardImpl("♥","5");
        Card c2 = new CardImpl("♠","5");
        Card c3 = new CardImpl("♦","5");
        player.addCardHand(c1);
        player.addCardHand(c2);
        player.addCardHand(c3);
        List<Card> cardsToPut = List.of(c1, c2, c3);
    
        player.setInPot(false); 
    
        PutCombinationResult result = controller.tryPutCombination(cardsToPut);

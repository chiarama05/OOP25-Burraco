...
import view.button.DeckButton;
import view.button.TakeDiscardButton;
...
public class TableViewImpl implements TableView {
    ...
    public void wireControllers(model.turn.Turn turnModel) {
        ...
        new view.button.DiscardButton(this, turnModel, drawManager, discardView, notifier, discardCoreLogic );
